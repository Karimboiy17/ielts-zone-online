"""Auto-seed B1 MID (8) test data into MongoDB (used at app startup on Railway)."""
...
questions = [
    ...
    {"id": "r_p1", "type": "multiple_group", "section": "reading", "part": 1, "start_num": 1,
     ...
     "points": 5,
     "items": [
         {"q": "1. What does it say?", "notice": "Mike\n\nThis is the worst holiday I've ever been on – everything's really awful.\nPlease contact the travel agent. I really need to get an earlier plane home.\n\nSpeak soon\nJane",
          "options": ["take a plane and join her soon", "find out about flights for her", "plan another holiday for her"],
          "answer": 1},
         {"q": "2. What does it say?", "notice": "Gilly,\n\nTina called – she wants to go to the new shopping centre after work tonight. She wants you to go too.\nPlease phone her back before 6 p.m.\n\nMum",
          ...
          "answer": 2},
         {"q": "3. What does it say?", "notice": "Tom – your colleague Pete called about the trip. Please send him an email with the details of when you're leaving on Saturday. He wants to make sure he'll be at your house on time.",
          ...
          "answer": 2},
         {"q": "4. What does it say?", "notice": "TUESDAY ONLY\nRemember – show your customer card before you pay to get special offers.",
          ...
          "answer": 0},
         {"q": "5. What does it say?", "notice": "Laura, your friend Jess called. She is giving away some vegetables from her garden. Call her later if you want some. You can pick them up tomorrow.",
