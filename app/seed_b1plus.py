...
LISTENING_QUESTIONS = [
    {"id": "l_p1", "type": "multiple_group", "section": "listening", "part": 1, "start_num": 1,
     ...
     "points": 5,
     "items": [
         {"q": "1. What does mum say Helen's brother can eat?",
          "option_images": [IMG + "lq1_A.png", IMG + "lq1_B.png", IMG + "lq1_C.png"],
          "options": ["A", "B", "C"], "answer": 1},
         {"q": "2. What does the man complain about?",
          "option_images": [IMG + "lq2_A.png", IMG + "lq2_B.png", IMG + "lq2_C.png"],
          "options": ["A", "B", "C"], "answer": 2},
         {"q": "3. At what time might the road be OK to use?",
          "option_images": [IMG + "lq3_A.png", IMG + "lq3_B.png", IMG + "lq3_C.png"],
          "options": ["A", "B", "C"], "answer": 2},
         {"q": "4. How much is a return flight to Paris at the moment?",
          "option_images": [IMG + "lq41_A.png", IMG + "lq41_B.png", IMG + "lq41_C.png"],
          "options": ["A", "B", "C"], "answer": 0},
         {"q": "5. Which programme has been cancelled?",
          "option_images": [IMG + "lq42_A.png", IMG + "lq42_B.png", IMG + "lq42_C.png"],
          "options": ["A", "B", "C"], "answer": 1},
     ]},
